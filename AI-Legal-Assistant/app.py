...
st.set_page_config(
    page_title="LexAI | AI Legal Assistant",
    page_icon="⚖️",
    layout="wide",
...
st.markdown(
    ...
    <section class="hero">
        ...
        <h1 class="hero-title">
            Understand legal documents faster.
        </h1>

        <p class="hero-subtitle">
            Upload legal PDFs, ask document-grounded
            questions, generate summaries, review
            important clauses and identify areas that
...
st.warning(
    "⚠️ LexAI provides automated document-based "
    ...
    with col4:
        ...
        st.markdown(
            ...
            <div class="feature-card">
                ...
                <div class="feature-text">
                    Highlight provisions that may
                    deserve closer human review.
                </div>
